...
import ramuan
from ramuan.lib.curve.ttypes import *
from datetime import datetime
import time,random,sys,re,os,json,subprocess,codecs,threading,glob

acil = ramuan.LINE()
acil.login(token="Eqhd9umlNsvKaiYjuWua.UML/F5OMmCzegj+kXFSa6G.HJoHVfwEESAVKw5kfjSqOgvqabhVUj71XTu69Sc3nn8=")
acil.loginResult()

pb1 = ramuan.LINE()
pb1.login(token="EqHqHlafs2qbuO3Q3Gh7.w7PintyRt9WjtuWkjx6InW.IBulHI3h9j+1x920cpYIr7OR1mMrV1Vdv6gip27RU8o=")
pb1.loginResult()

pb2 = ramuan.LINE()
pb2.login(token="EqxyDJ61rU1FH9ZMYbp9.5RaliWBlzSi7P4maDE0AYq.GbUvWgS5Wx4thZpOnzcbUgG/j1Q7DSelMwqWgWNohPk=")
pb2.loginResult()
...
admsa = "uba697e7f9a2631c644189fcac5fb00ea"
...
wait = {
    ...
    'timeline':False,
    'autoAdd':True,
    'message':"""❂••••AUTO ADD BY CHANNEL SIHIR••••❂\nhttps://www.youtube.com/channel/UCl3cMOdVtCmBxNCK6VqQK5g\n❂•••JANGAN LUPA DI SUBSCRIBE YA••••❂""",
    "lang":"JP",
    "comment1":"❂••••AUTO ADD BY CHANNEL SIHIR••••❂\nhttps://www.youtube.com/channel/UCl3cMOdVtCmBxNCK6VqQK5g\n❂•••JANGAN LUPA DI SUBSCRIBE YA••••❂",
    ...
    try:
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid': 'u10bc9fb6bcc54250356717335889864f'}
                acil.sendMessage(msg)
...
#                else:
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    acil.sendText(msg.to,"􀜁􀇔􏿿semua nama botsihirs telah di update menjadi\n👉 " + string + "👈")
...
#--------------------------------------------------------
                ...
                for i in gid:
                    ...
                    ki6.leaveGroup(i)
                if wait["lang"] == "JP":
                    acil.sendText(msg.to,"BOTSIHIR Sudah Keluar Di semua grup")
                else:
...
#-----------------------------------------------------------
                    ...
                    acil.sendText(msg.to, "Cekrek yg cctv")
                    try:
                    ...
                    if msg.to in wait2['readPoint']:
                        if wait2["ROM"][msg.to].items() == []:
                            ...
                            for rom in wait2["ROM"][msg.to].items():
                                print rom
                                chiya += rom[1] + "\n"
                        acil.sendText(msg.to,"🔴🔴🔴Hayo Ketauan🔴🔴🔴 %s\n🔴🔴🔴🔴🔴Tercyduk🔴🔴🔴🔴🔴\n%s\Gabung ah jangan ngintip😉😉 :\n[%s]" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                    else:
                         acil.sendText(msg.to,"Dih belum disetting tauu.\n「set」dulu😪😪😪 ♪ baru minta yg lain ♪")
#-------------------------------------------------
...
#	      if msg.from_ in admin:
		       ...
		       acil.sendText(msg.to,"Wating in progres...\nhttps://www.youtube.com/channel/UCl3cMOdVtCmBxNCK6VqQK5g")
                       acil.sendText(g.mid,"https://www.youtube.com/channel/UCl3cMOdVtCmBxNCK6VqQK5g")
                       pb1.sendText(g.mid,"https://www.youtube.com/channel/UCl3cMOdVtCmBxNCK6VqQK5g")
                       pb2.sendText(g.mid,"https://www.youtube.com/channel/UCl3cMOdVtCmBxNCK6VqQK5g")
                       acil.sendText(g.mid,"https://www.youtube.com/channel/UCl3cMOdVtCmBxNCK6VqQK5g")
                       pb1.sendText(g.mid,"https://www.youtube.com/channel/UCl3cMOdVtCmBxNCK6VqQK5g")
                       pb2.sendText(g.mid,"https://www.youtube.com/channel/UCl3cMOdVtCmBxNCK6VqQK5g")
                       pb1.sendText(g.mid,"https://www.youtube.com/channel/UCl3cMOdVtCmBxNCK6VqQK5g")
...
#-----------------------------------------------------------
            elif msg.text.lower() == 'siaga':
                profile = pb1.getProfile()
                text = profile.displayName + "􀜁􀇔􏿿siap"
                pb1.sendText(msg.to, text)
                profile = pb2.getProfile()
                text = profile.displayName + "􀜁􀇔􏿿 siap86"
...
#---------------------- = NUKE = ------------------
                ...
                if msg.toType == 2:
                    ...
                    acil.sendText(msg.to,"https://www.youtube.com/channel/UCl3cMOdVtCmBxNCK6VqQK5g")
                    targets = []
                    for g in gs.members:
...
#-------------Fungsi Tagall User Start---------------#
            elif msg.text in ["sambat","Tagall","Absen","Tag"]:
                group = acil.getGroup(msg.to)
...
#-------------------------------------------------------------
                ...
                try:
                    ...
                    acil.sendText(msg.to,"Error")
            elif "fako" in msg.text:
                try:
                    source_str = 'abcdefghijklmnopqrstuvwxyz1234567890@:;./_][!&%$#)(=~^|'
                    name = "".join([random.choice(source_str) for x in xrange(10)])
                    amid = msg.text.replace("fako","")
...
#-----------------------------------------------
            elif msg.text.lower() == 'prok prok prok':
                        G = acil.getGroup(msg.to)
                        ginfo = acil.getGroup(msg.to)
                        G.preventJoinByTicket = False
                        acil.updateGroup(G)
...
#-----------------------------------------------
                ...
                if msg.toType == 2:
                    ginfo = acil.getGroup(msg.to)
                    try:
                        acil.sendText(msg.to,"Bye Bye😘 jangan lupa subscribe channel youtube nya\nhttps://www.youtube.com/channel/UCl3cMOdVtCmBxNCK6VqQK5g\n"  +  str(ginfo.name)  + "")
...
#-----------------------------------------------
                ...
                ginfo = acil.getGroup(msg.to)
                acil.sendText(msg.to,"Selamat gabung Di Grup " + str(ginfo.name))
                acil.sendText(msg.to,"Salim dulu sama " + str(ginfo.name) + " :\n" + ginfo.creator.displayName )
            elif "Bc " in msg.text:
                ...
                pb1.sendText(msg.to,"Ping 💯✔")
                pb2.sendText(msg.to,"Pong 💯✔")
